...
std::unique_ptr<folly::IOBuf> formatPrometheus(const MoqxRelayContext::TrackMetricsResult& result) {
  ...
  static constexpr std::array<Series, 12> kSeries = {{
      {"moqx_track_groups_received_total",
       ...
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.groupsReceived; }},
      {"moqx_track_subgroups_received_total",
       "counter",
       "Subgroups ingested",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.subgroupsReceived; }},
      {"moqx_track_objects_received_total",
       "counter",
       "Objects ingested",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.objectsReceived; }},
      {"moqx_track_datagrams_received_total",
       "counter",
       "Objects ingested as datagrams",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.datagramsReceived; }},
      {"moqx_track_bytes_received_total",
       "counter",
       "Object payload bytes ingested",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.bytesReceived; }},
      {"moqx_track_groups_sent_total",
       "counter",
       "Groups delivered, summed over subscribers",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.groupsSent; }},
      {"moqx_track_subgroups_sent_total",
       "counter",
       "Subgroups delivered, summed over subscribers",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.subgroupsSent; }},
      {"moqx_track_objects_sent_total",
       "counter",
       "Objects delivered, summed over subscribers",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.objectsSent; }},
      {"moqx_track_datagrams_sent_total",
       "counter",
       "Objects delivered as datagrams, summed over subscribers",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.datagramsSent; }},
      {"moqx_track_bytes_sent_total",
       "counter",
       "Object payload bytes delivered, summed over subscribers",
       [](const stats::TrackCounters& c, const ClockAnchor&) { return c.bytesSent; }},
      {"moqx_track_publish_start_timestamp_seconds",
       "gauge",
       "Unix time the relay first saw the track",
       [](const stats::TrackCounters& c, const ClockAnchor& a) {
         return a.toUnixSeconds(c.publishStart);
       }},
      {"moqx_track_last_object_timestamp_seconds",
       "gauge",
       "Unix time of the most recent ingested object",
       [](const stats::TrackCounters& c, const ClockAnchor& a) {
         return a.toUnixSeconds(c.lastObject);
       }},
  }};
