...
MoQSubscriberCrossExecFilter::publishNamespace(
...
moxygen::Subscriber::PublishResult MoQSubscriberCrossExecFilter::publish(
    moxygen::PublishRequest pub,
    std::shared_ptr<moxygen::SubscriptionHandle> handle
) {
  auto filter = std::make_shared<MoQCrossExecFilter>(targetExec_, nullptr);
...
MoQSubscriberCrossExecFilter::coPublish(
    moxygen::PublishRequest pub,
    std::shared_ptr<moxygen::SubscriptionHandle> handle,
...
void MoQSubscriberCrossExecFilter::goaway(moxygen::Goaway goaway) {
