...
# the checkout on its way out. --strict turns the shared script's warn-and-continue
# into the die this script's other preconditions use.
if ((sync_moxygen_dir)); then
  scripts/dev/sync-moxygen.sh --strict --dir "$moxygen_dir" \
